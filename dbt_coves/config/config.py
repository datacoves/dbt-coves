...
class DbtCovesConfig:
    ...
    CLI_OVERRIDE_FLAGS = [
        ...
        "generate.sources.model-props-strategy",
        "generate.sources.templates-folder",
        "generate.sources.metadata",
        "extract.airbyte.path",
        "extract.airbyte.host",
        "extract.airbyte.port",
        "extract.airbyte.dbt-list-args",
        "load.airbyte.path",
        "load.airbyte.host",
        "load.airbyte.port",
        "load.airbyte.secrets-manager",
        "load.airbyte.secrets-url",
        "load.airbyte.secrets-token",
        "load.airbyte.secrets-path",
        "load.airbyte.dbt-list-args",
        "setup.all.templates",
        "setup.all.open-ssl-public-key",
        "setup.sqlfluff.templates",
        "setup.precommit.templates",
        "setup.ssh.open-ssl-public-key",
    ]
